# Take images on the JetBot with a gamepad controller and two cameras
...
def stream_camera():
    ...
    #display = jetson.utils.videoOutput("", argv=sys.argv + is_headless)
