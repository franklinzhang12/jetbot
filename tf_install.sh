...
sudo pip3 install numpy==1.18.5 cython==0.29.16 pkgconfig 
sudo pip3 install h5py==2.10.0 
sudo pip3 install -U pip future==0.17.1 mock==3.0.5 keras_preprocessing==1.0.5 keras_applications==1.0.8 gast==0.3.3 futures protobuf pybind11
